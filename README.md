...
<p align="center">
<span>
<img src="https://acged.cc/svg/php.svg" alt="php8.0,8.1,8.2">
</span>
<span>
...
- 在安装之前，请检查你的系统环境，`php>=8.0 (推荐 8.2)`，`MySQL版本>=5.6[不推荐5.6后续升级可能会有问题，推荐5.7或者8.0]`，已对 PHP 8.2 做兼容性修复（动态属性、弃用函数）。首页默认显示按钮门户，点击按钮进入对应服务。
